 ...
 * <tr><td>bytes</td><td>0x400</td><td>0x0</td><td>remove trailing 0's</td><td>byte[]</td><td>{@link Utf8$1024Visitor#bytes(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see model.Utf8$1024#bytes
 * </table>
 */
public enum Utf8$1024 { 
bytes(0x400)	{{
...
;
    ...
    /** Utf8$1024 templated Byte Struct 
     * @param dimensions [0]=___size___,[1]= forced ___seek___
     */
	Utf8$1024 (int... dimensions) {
    ...
    static void index
        ...
        for (Utf8$1024 Utf8$1024_ : values()) {
            String hdr = Utf8$1024_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            Utf8$1024_.subIndex(src, register, stack);
        }
    }
