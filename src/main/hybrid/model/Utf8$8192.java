 ...
 * 
 * @see model.Utf8$8192#bytes
 * </table>
 */
public enum Utf8$8192 { 
bytes(0x2000)	{{
...
;
    ...
    /** Utf8$8192 templated Byte Struct 
     * @param dimensions [0]=___size___,[1]= forced ___seek___
     */
	Utf8$8192 (int... dimensions) {
    ...
    static void index
        ...
        for (Utf8$8192 Utf8$8192_ : values()) {
            String hdr = Utf8$8192_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            Utf8$8192_.subIndex(src, register, stack);
        }
    }
