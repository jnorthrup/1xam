 ...
 * <tr><td>bytes</td><td>0x80</td><td>0x0</td><td>remove trailing 0's</td><td>byte[]</td><td>{@link Utf8$128Visitor#bytes(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see model.Utf8$128#bytes
 * </table>
 */
public enum Utf8$128 { 
bytes(0x80)	{{
...
;
    ...
    /** Utf8$128 templated Byte Struct 
     * @param dimensions [0]=___size___,[1]= forced ___seek___
     */
	Utf8$128 (int... dimensions) {
    ...
    static void index
        ...
        for (Utf8$128 Utf8$128_ : values()) {
            String hdr = Utf8$128_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            Utf8$128_.subIndex(src, register, stack);
        }
    }
