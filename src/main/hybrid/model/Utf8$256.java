 ...
 * 
 * @see model.Utf8$256#bytes
 * </table>
 */
public enum Utf8$256 { 
bytes(0x100)	{{
...
;
    ...
    static void index
        ...
        for (Utf8$256 Utf8$256_ : values()) {
            String hdr = Utf8$256_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            Utf8$256_.subIndex(src, register, stack);
        }
    }
