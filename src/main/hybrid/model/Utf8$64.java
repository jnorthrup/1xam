 ...
 * <tr><td>bytes</td><td>0x40</td><td>0x0</td><td>remove trailing 0's</td><td>byte[]</td><td>{@link Utf8$64Visitor#bytes(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see model.Utf8$64#bytes
 * </table>
 */
public enum Utf8$64 { 
bytes(0x40)	{{
...
;
    ...
    /** Utf8$64 templated Byte Struct 
     * @param dimensions [0]=___size___,[1]= forced ___seek___
     */
	Utf8$64 (int... dimensions) {
    ...
    static void index
        ...
        for (Utf8$64 Utf8$64_ : values()) {
            String hdr = Utf8$64_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            Utf8$64_.subIndex(src, register, stack);
        }
    }
