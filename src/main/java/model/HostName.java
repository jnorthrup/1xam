 ...
 * <tr><td>Utf8$128</td><td>0x4</td><td>0x0</td><td></td><td>int</td><td>{@link HostNameVisitor#Utf8$128(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see model.HostName#Utf8$128
 * </table>
 */
...
Utf8$128;
    ...
    /** HostName templated Byte Struct 
     * @param dimensions [0]=___size___,[1]= forced ___seek___
     */
	HostName (int... dimensions) {
    ...
    static void index
        ...
        for (HostName HostName_ : values()) {
            String hdr = HostName_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            HostName_.subIndex(src, register, stack);
        }
    }
